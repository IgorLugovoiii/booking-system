package com.example.notification_service.aspects;

import com.example.notification_service.kafka.producers.LogProducer;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.example.notification_service..*(..) && !within(com.example.notification_service.aspects.LoggingFilter) && !within(com.example.notification.kafka.LogProducer)")
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        logMap.put("service", "notification-service");
