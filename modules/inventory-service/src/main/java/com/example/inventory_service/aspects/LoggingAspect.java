...
public class LoggingAspect {
    ...
    @Around("execution(* com.example.inventory_service..*(..)) && !within(com.example.inventory_service.aspects.LoggingFilter)  && !within(com.example.inventory_service.kafka.LogProducer)")
